...
path+=('/home/hussar/.local/.scripts')
path+=('/home/hussar/langs/.cargo/bin')
path+=('/home/hussar/langs/go/bin')

export HYPRLAND_HEADERS="/home/hussar/Personal/repos/Hyprland-Plugins/Hyprland"
